...
#Xander Nuttle
#mrsim_single_age_no_selection_with_recurrence_650_kya.sh
#Call: qsub /net/gs/vol2/home/xnuttle/bola2_paper/popgen_sims_xn/analysis_programs/mrsim_single_age_no_selection_with_recurrence_650_kya.sh number_of_replicates_per_mu_value
...
cd $SIMS_DIR
NREPS=$1
bash $PROGRAM_DIR/sim_bola2b_single_age_no_selection_with_recurrence_650_kya.sh $NREPS $SIM_OUT_DIR
